...
def test_analyze_dataset_ips_path_works():
...
def test_service_auto_selects_calibrated_ips_without_fresh_draws():
...
def test_service_auto_selects_stacked_dr_with_fresh_draws():
...
def test_cli_analyze_ips_quiet():
...
def test_cli_analyze_auto_with_fresh_draws_quiet():
