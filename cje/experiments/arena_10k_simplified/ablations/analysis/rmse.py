...
def compute_rmse_metrics(results: List[Dict[str, Any]]) -> pd.DataFrame:
    ...
    for result in results:
        ...
        rows.append({
            ...
            "reward_calibration_mode": result.get("reward_calibration_mode", "unknown"),
...
def compute_debiased_rmse(
    ...
    for result in results:
        ...
        rows.append({
            ...
            **{f"{p}_rmse_debiased": policy_debiased.get(p, np.nan) for p in WELL_BEHAVED_POLICIES}
        })
