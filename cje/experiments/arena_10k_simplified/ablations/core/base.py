...
class BaseAblation:
    ...
    def load_cached_result(self, spec: ExperimentSpec, seed: int) -> Optional[Dict[str, Any]]:
    ...
    def create_estimator(self, spec: ExperimentSpec, sampler: PrecomputedSampler, cal_result: Any) -> Any:
        ...
        estimator_map = {
            ...
            "dr-cpo": lambda s: DRCPOEstimator(
                ...
                n_folds=5,
                oracle_slice_config=spec.oracle_coverage < 1.0 if spec.oracle_coverage else False
            ),
        ...
        for policy in policies:
            try:
                ...
                if weights is not None and len(weights) > 0:
                    ...
                    result["ess_relative"][policy] = 100.0 * ess / n_total if n_total > 0 else 0
    ...
    def run_single(self, spec: ExperimentSpec, seed: int) -> Dict[str, Any]:
        ...
        try:
            ...
            if result["confidence_intervals"]:
                widths = [ci[1] - ci[0] for ci in result["confidence_intervals"].values()]
